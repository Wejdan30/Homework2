...
1.Wejdan Abdulrhman Al-Harthy ID:2201001406
...
Answer: observation : 953 variables: 26 represent ont person who had get
nobel
...
Answer: The number of winners born in the US is 105
...
nobel_living_science %>% 
  ggplot(aes(x = country_us,y=born_country_us,fill=category)) + geom_bar(stat = "identity" , position = "dodge" ,orientation = "horizontal")
```

![](lab-05_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->

Answer: Yes, because at buzzfeed we analyze data to find more
understanding of the data in order to obtain information, so we dive
into it and do a lot of filtering to understand the data.
...
Answer: The most common are Germany and the United Kingdom
